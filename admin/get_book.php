...
if(!empty($_POST["bookid"])) {
  $bookid=$_POST["bookid"];
    ...
    $sql ="SELECT distinct tblbooks.BookName,tblbooks.id,tblauthors.AuthorName,tblbooks.bookImage,tblbooks.BookAvailQuantity,tblbooks.isIssued FROM tblbooks
...
<table border="1">
    ...
    <tr>
        ...
        <th style="padding-left:5%; width: 10%;">
            ...
            <?php if($result->BookAvailQuantity=='0'): ?>
            <p style="color:red;">Book Not Available</p>
            <?php else:?>
            <p style="color:green;">Available Books: <?php echo htmlentities($result->BookAvailQuantity); ?></p>
