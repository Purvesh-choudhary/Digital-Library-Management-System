...
<head>
    ...
    <title>Digital Library Management System | Add Book</title>
...
{               ?>
                                ...
                                <button type="submit" name="add" id="add" class="btn btn-info" style="margin-top:40px; float:right; margin-right:30px;">ADD BOOK </button>
